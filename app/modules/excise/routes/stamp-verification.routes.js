...
export const buildStampVerificationRouter = ({ stampVerificationController }) => {
  ...
  adminRouter.get('/stamp-verifications/summary', stampVerificationController.getSummary);
  adminRouter.get(
    '/stamp-verifications/:id',
    validateParams(idParamsSchema),
    stampVerificationController.getById,
